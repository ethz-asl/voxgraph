...
#ifndef VOXGRAPH_POSE_GRAPH_CONSTRAINT_ABSOLUTE_POSE_CONSTRAINT_H_
#define VOXGRAPH_POSE_GRAPH_CONSTRAINT_ABSOLUTE_POSE_CONSTRAINT_H_
...
#endif  // VOXGRAPH_POSE_GRAPH_CONSTRAINT_ABSOLUTE_POSE_CONSTRAINT_H_
