...
#ifndef VOXGRAPH_ODOMETRY_SIMULATOR_NORMAL_DISTRIBUTION_H_
#define VOXGRAPH_ODOMETRY_SIMULATOR_NORMAL_DISTRIBUTION_H_
...
#endif  // VOXGRAPH_ODOMETRY_SIMULATOR_NORMAL_DISTRIBUTION_H_
